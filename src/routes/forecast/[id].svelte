...
<script lang="ts">
    ...
    onMount(async () => {
        ...
        const res = await fetch(`https://api.open-meteo.com/v1/forecast?latitude=${lat}&longitude=${lon}&hourly=temperature_2m,relativehumidity_2m,surface_pressure,precipitation,weathercode,windspeed_10m,winddirection_10m,windgusts_10m&current_weather=true&windspeed_unit=kn&timezone=${timezone}`)
...
<div class="w-full flex flex-col items-center">
    ...
    {#if weatherdata}
        ...
        <div class="hidden lg:flex lg:flex-col lg:items-center">
            ...
            <Forecast data={weatherdata} day=3/>
            <Forecast data={weatherdata} day=4/>
            <Forecast data={weatherdata} day=5/>
            <Forecast data={weatherdata} day=6/>
        </div>
        <div class="flex flex-col items-center w-full lg:hidden">
            ...
            <MobileForecast data={weatherdata} day=3/>
            <MobileForecast data={weatherdata} day=4/>
            <MobileForecast data={weatherdata} day=5/>
            <MobileForecast data={weatherdata} day=6/>
        </div>
    {:else}
        <svg
